...
const TrackingMapNative = ({ selectedOrder, routeCoordinates, primaryColor }) => {
  // Posisi live seller (kalau sudah ada update dari app seller). Beda dari
  // sellerLat/sellerLng (titik pin toko yang statis) — ini posisi terkini
  // selama order berstatus 'delivery'.
  ...
  return (
    ...
    >
      {/* Titik toko (statis, pin yang di-set sekali waktu daftar) */}
      ...
      {/* Posisi live seller sekarang — cuma muncul kalau sudah ada update lokasi */}
      {hasLiveLocation && (
        <Marker
