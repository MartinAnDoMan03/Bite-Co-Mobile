...
termsContent: {
  ...
  intro: 'Dengan menggunakan aplikasi Bite&Co, kamu dianggap telah membaca dan menyetujui ketentuan berikut.',
  sections: [
    {
      icon: 'info',
      title: 'Tentang Layanan',
      body: 'Bite&Co adalah platform yang menghubungkan pengguna dengan mitra UMKM katering dan rantangan melalui sistem langganan (harian, mingguan, bulanan) di wilayah Medan.',
    },
    {
      icon: 'account-circle',
      title: 'Akun Pengguna',
      body: 'Kamu wajib mendaftar dengan data yang benar dan menjaga kerahasiaan akun sendiri. Segala aktivitas yang terjadi di akunmu menjadi tanggung jawabmu, kecuali jika ada bukti penyalahgunaan oleh pihak lain.',
    },
    {
      icon: 'payment',
      title: 'Pesanan dan Pembayaran',
      body: 'Setiap pesanan yang sudah dikonfirmasi mitra bersifat mengikat. Pembayaran dilakukan melalui metode yang tersedia di aplikasi. Pembatalan sepihak setelah pesanan diproses dapat dikenakan ketentuan tersendiri sesuai kebijakan mitra.',
    },
    {
      icon: 'storefront',
      title: 'Tanggung Jawab Mitra',
      body: 'Mitra bertanggung jawab penuh atas kualitas, kebersihan, dan keakuratan informasi produk yang didaftarkan, termasuk status halal. Proses pengantaran atau pengambilan pesanan sepenuhnya menjadi tanggung jawab mitra, termasuk ketepatan waktu dan kondisi produk saat sampai ke pengguna. Bite&Co berperan sebagai penghubung platform, bukan penyedia jasa pengiriman.',
    },
    {
      icon: 'attach-money',
      title: 'Komisi dan Biaya',
      body: 'Setiap transaksi yang berhasil dikenakan komisi platform sebesar 10% dari nilai pesanan, dipotong otomatis sebelum pencairan dana ke mitra.',
    },
    {
      icon: 'block',
      title: 'Larangan Penggunaan',
      body: 'Pengguna dan mitra dilarang menyalahgunakan platform untuk tujuan penipuan, memberikan informasi palsu, atau tindakan yang merugikan pihak lain di ekosistem Bite&Co.',
    },
    {
      icon: 'pause-circle-filled',
      title: 'Penangguhan Akun',
      body: 'Bite&Co berhak menonaktifkan sementara atau permanen akun yang terbukti melanggar ketentuan ini, baik berdasarkan laporan pengguna lain maupun hasil pemantauan internal.',
    },
    {
      icon: 'gavel',
      title: 'Batasan Tanggung Jawab',
      body: 'Bite&Co berupaya menjaga kelancaran layanan, namun tidak bertanggung jawab atas kerugian yang timbul akibat kesalahan mitra, gangguan teknis di luar kendali kami, atau force majeure.',
    },
    {
      icon: 'update',
      title: 'Perubahan Ketentuan',
      body: 'Ketentuan ini dapat berubah sewaktu-waktu. Perubahan akan diinformasikan melalui aplikasi, dan penggunaan berkelanjutan setelah perubahan dianggap sebagai persetujuan.',
    },
    {
      icon: 'mail',
      title: 'Kontak',
      body: 'Pertanyaan seputar syarat dan ketentuan ini bisa disampaikan ke support@bitenco.id.',
    },
  ],
},},
